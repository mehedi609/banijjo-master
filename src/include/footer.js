...
class Footer extends Component {
  render() {
    return (
      ...
      <h5 className="footerHeader" style={{ marginTop: "15px" }}>About us</h5>
      ...
      <h5 className="footerHeader" style={{ marginTop: "15px" }}>Special Category</h5>
      <ul className="nav-list" style={{ paddingLeft: "10px" }}>
      <li>
      <a href="#">Mens</a>
      </li>
      ...
      <h5 className="footerHeader" style={{ marginTop: "15px" }}>Contract us</h5>
      <p>NA</p>
      </div>
      </div>
      </footer>
      ...
      <div className="row">
      <div className="container">
      <div className="col-md-6" style={{ paddingLeft: "0px !important" }}>
